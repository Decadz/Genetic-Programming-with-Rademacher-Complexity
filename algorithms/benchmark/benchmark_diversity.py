...
===============================================================================================================
    ...
    - Modified selection algorithm which gives each individual a dominance rating.

===============================================================================================================
"""


def sel_domination(individuals, select):

    """
    Finds all the (pareto) front and puts them in order from front to back,
    returns as a single ordered list from non-dominated to very dominated.

    :param individuals: Population of Individuals
    :param select: The number of individuals to select.
    :return: A ordered list from non-dominated to very dominated.
    """

    # Sorts into an ordered list containing each front (best-worst).
    pareto_fronts = emo.sortNondominated(individuals, select)

    # Joining all the fronts into one list (except for the last individual).
    return list(chain(*pareto_fronts[:]))


"""
===============================================================================================================

    - Fitness Functions (Absolute Error, Sum Squared Error, Mean Squared Error)
...
toolbox.register("select", sel_domination)
